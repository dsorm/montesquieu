...
# register all args
ENV BLOGNAME="" ARTICLESPERPAGE=5 LISTENON=80 ARTICLESTORE="mock" ARTICLESTORE_HOST="" ARTICLESTORE_DB="" ARTICLESTORE_USER="" ARTICLESTORE_PASSWORD="" CACHINGENGINE="" HOTSWAPTEMPLATES="no"
